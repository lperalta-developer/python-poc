...
def main():
    ...
    fixed_point = (434, 231)
    closest_coords = get_closest_coords(df, fixed_point, max_radii).to_string(index=False)
    #print(f"\nClosest to fixed point ({fixed_point[0]}, {fixed_point[1]}) within a radius of {max_radii}: \n{closest_coords}")
